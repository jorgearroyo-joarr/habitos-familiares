...
def upgrade() -> None:
    # ================================================================
    # IDEMPOTENT UPGRADE — safe to run on both fresh and existing DBs.
    # On Render/PostgreSQL the schema may already exist (created before
    # Alembic was introduced).  Without these guards every startup fails
    # with "table already exists", the migration transaction rolls back,
    # alembic_version is never written, and the server loops forever.
    # ================================================================
    bind = op.get_bind()
    ...
    if "app_settings" not in existing:
        ...
        # admin_pin_hash is NOT NULL — placeholder; seed_default_data overwrites it
    ...
    # ============================================================
    if "habit_templates" not in existing:
        op.create_table(
            "habit_templates",
            sa.Column("id", sa.Integer(), nullable=False),
    ...
    # TABLE: micro_habits
    # ============================================================
    if "micro_habits" not in existing:
        op.create_table(
            "micro_habits",
            sa.Column("id", sa.Integer(), nullable=False),
    ...
    # TABLE: habit_entries
    # ============================================================
    if "habit_entries" not in existing:
        op.create_table(
            "habit_entries",
            sa.Column("id", sa.Integer(), nullable=False),
    ...
    # TABLE: week_rewards
    # ============================================================
    if "week_rewards" not in existing:
        op.create_table(
            "week_rewards",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("profile_id", sa.Integer(), nullable=False),
    ...
    # TABLE: month_rewards
    # ============================================================
    if "month_rewards" not in existing:
        op.create_table(
            "month_rewards",
            sa.Column("id", sa.Integer(), nullable=False),
            sa.Column("profile_id", sa.Integer(), nullable=False),
